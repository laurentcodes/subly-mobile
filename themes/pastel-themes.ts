...
export const defaultTheme: ThemeConfig = {
  light: {
    colors: {
      // base colors - clean white with subtle purple hints
      background: 'hsl(0 0% 100%)',
      foreground: 'hsl(260 15% 20%)',
      panel: 'hsl(260 40% 98%)',
      muted: 'hsl(260 10% 50%)',
      mutedForeground: 'hsl(260 8% 60%)',
      surface: 'hsl(260 30% 97%)',
      surfaceForeground: 'hsl(260 20% 25%)',
      default: 'hsl(260 25% 96%)',
      defaultForeground: 'hsl(260 15% 35%)',

      // accent colors - vibrant purple as primary
      accent: 'hsl(260 75% 60%)', // main purple
      accentForeground: 'hsl(0 0% 100%)',
      accentSoft: 'hsl(260 60% 95%)',
      accentSoftForeground: 'hsl(260 70% 45%)',
      ...
      // surface colors - progressive depth
      surface1: 'hsl(0 0% 100%)',
      surface2: 'hsl(260 35% 98%)',
      surface3: 'hsl(260 30% 96%)',

      // misc colors
      border: 'hsl(260 20% 90%)',
      divider: 'hsl(260 15% 85%)',
      link: 'hsl(260 75% 55%)',
    },
    borderRadius: {
      DEFAULT: '12px',
  ...
  dark: {
    colors: {
      // base colors - deep dark with purple undertones
      background: 'hsl(260 20% 8%)',
      foreground: 'hsl(260 10% 95%)',
      panel: 'hsl(260 18% 12%)',
      muted: 'hsl(260 8% 45%)',
      mutedForeground: 'hsl(260 6% 65%)',
      surface: 'hsl(260 16% 14%)',
      surfaceForeground: 'hsl(260 10% 90%)',
      default: 'hsl(260 15% 16%)',
      defaultForeground: 'hsl(260 8% 85%)',

      // accent colors - brighter purple for dark mode
      accent: 'hsl(260 70% 65%)',
      accentForeground: 'hsl(260 20% 10%)',
      accentSoft: 'hsl(260 40% 25%)',
      accentSoftForeground: 'hsl(260 60% 80%)',

      // status colors - vivid but not harsh
      success: 'hsl(140 50% 55%)',
      successForeground: 'hsl(140 60% 10%)',
      warning: 'hsl(35 75% 60%)',
      warningForeground: 'hsl(35 40% 10%)',
      danger: 'hsl(0 65% 60%)',
      dangerForeground: 'hsl(0 60% 10%)',

      // surface colors - layered depth
      surface1: 'hsl(260 20% 8%)',
      surface2: 'hsl(260 18% 12%)',
      surface3: 'hsl(260 16% 16%)',

      // misc colors
      border: 'hsl(260 15% 22%)',
      divider: 'hsl(260 12% 28%)',
      link: 'hsl(260 70% 70%)',
    },
    borderRadius: {
      DEFAULT: '12px',
